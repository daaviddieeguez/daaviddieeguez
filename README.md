...
Me gusta la programación y disfruto aprendiendo cosas nuevas del mundo del desarrollo. Tengo una base sólida en **Java (POO)**, donde estoy avanzando con **JDBC** para la conexión a bases de datos, y estoy ampliando mis habilidades activamente en:

* **Desarrollo Móvil:** Aprendiendo **React Native**, **Flutter** y **Kotlin**.
* **Desarrollo Backend:** Aprendiendo **Laravel** y **PHP**.
* **Herramientas y BBDD:** Uso diariamente **Git**, **GitHub**, **PostgreSQL** y **MariaDB**.

Mi próximo gran objetivo es dominar **Docker** para la gestión de contenedores.
...
- 🛠️ Mejorando proyectos personales en **Java** 
